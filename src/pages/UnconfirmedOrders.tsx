...
import { Home, ShoppingCart, Package, LogOut, Clock, User, Mail, Phone, MapPin, Calendar, ChevronDown, ChevronUp, Search, Shield } from 'lucide-react';
...
const UnconfirmedOrders = () => {
  ...
  console.log('UnconfirmedOrders render - user:', user, 'authLoading:', authLoading, 'orders:', orders, 'loading:', loading);

  useEffect(() => {
    console.log('useEffect triggered, user:', user);
    if (user) {
      console.log('User found, calling fetchUnconfirmedOrders');
  ...
  const fetchUnconfirmedOrders = async () => {
    try {
      console.log('Fetching unconfirmed orders...');
      ...
      const response = await fetch(`https://fsirlcxhtyppecjjdqbp.supabase.co/functions/v1/get-orders?status=pending&scope=mine`, {
        headers: {
      ...
      <div className="flex-1 bg-white">
        <div className="p-8">
           ...
           <div className="flex items-center gap-3 mb-8">
             ...
             <h1 className="text-3xl font-bold text-gray-800">Vahvistamattomat tilaukset</h1>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-gray-600 mb-2">Ei vahvistamattomia tilauksia</h3>
              <p className="text-gray-500">Kaikki tilaukset on jo vahvistettu tai ei ole uusia tilauksia.</p>
            </div>
                     ) : (
                       ...
                       <div className="flex items-center gap-4">
                         <div>
                           ...
                           <p className="text-sm text-gray-600">
                             Luotu: {formatDate(order.created_at)}
                           </p>
                         </div>
